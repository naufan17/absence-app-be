/*
  ...
  - The values [cancel] on the enum `LeaveStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "LeaveStatus_new" AS ENUM ('pending', 'cancelled', 'revoked', 'approved', 'rejected');
